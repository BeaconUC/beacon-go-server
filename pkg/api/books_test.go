...
//	mockRepo.EXPECT().Healthcheck(gomock.Any()).Do(
//		func(c *gin.Context) {
...
//	mockGormDB.EXPECT().Find(gomock.Any()).DoAndReturn(
//		func(books *[]models.Book) *gorm.DB {
...
//	mockCache.EXPECT().Keys(ctx, keyPattern).Return(
//		redis.NewStringSliceResult(
//			[]string{"books_offset_0_limit_10"},
//			nil,
//		),
//	)
...
//		Where("id = ?", "1").
//		DoAndReturn(
//			func(query interface{}, args ...interface{}) database.Database {
...
//		First(gomock.Any()).
//		DoAndReturn(
//			func(dest interface{}, conds ...interface{}) database.Database {
